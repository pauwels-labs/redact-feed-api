...
export JENKINS_X_URL='https://dashboard.dev.pauwelslabs.com/pauwels-labs/redact-feed-api/main/13'
...
export MINK_IMAGE='274295908850.dkr.ecr.eu-west-1.amazonaws.com/pauwels-labs/redact-feed-api:0.4.2'
