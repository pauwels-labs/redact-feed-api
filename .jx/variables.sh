...
export JENKINS_X_URL='https://dashboard.dev.pauwelslabs.com/pauwels-labs/redact-feed-api/main/10'
...
export MINK_IMAGE='274295908850.dkr.ecr.eu-west-1.amazonaws.com/pauwels-labs/redact-feed-api:0.3.6'
